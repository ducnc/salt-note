...
#  - unless: rm cirros-0.3.3-x86_64 && wget pillar[glance][cirros_url]

#create_image_cirros:
# cmd.run:
#  - name: glance image-create --name "cirros-0.3.3-x86_64" --disk-format qcow2 --container-format bare --is-public True --progress < cirros-0.3.3-x86_64-disk.img
